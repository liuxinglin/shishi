...
@section('content')
    ...
    <div class="container order" id="container" style="height: 100%;overflow: scroll">
        <div class="weui-navbar">
            ...
            <div class="weui-navbar__item collect @if(isset($_GET['order_status']) && $_GET['order_status'] == 2) weui-bar__item_on @endif">
                <p>待收货</p>
                <p>0</p>
            </div>
        ...
        <div class="weui-tab">
            <div class="weui-tab__panel order-list">
                ...
                <div class="weui-panel weui-panel_access" id="pay" @if(!isset($_GET['order_status']) || $_GET['order_status'] != 0) style="display: none" @endif>
                    <div class="weui-panel__bd">
                        @foreach($orderList as $order)
