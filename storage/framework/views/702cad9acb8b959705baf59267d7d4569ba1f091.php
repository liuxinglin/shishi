    ...
    <div class="container member" id="container">
        <div class="weui-media-box weui-media-box_text info">
            <div class="weui-media-box__hd">
                <img class="weui-media-box__thumb" src="<?php echo e($member['headimgurl']); ?>" alt="">
            </div>
            <h4 class="weui-media-box__title nickname"><?php echo e($member['nickname']); ?></h4>
            ...
            <div class="weui-panel__bd">
                <div class="weui-media-box weui-media-box_small-appmsg">
                    <div class="weui-cells">
                        ...
                        <a class="weui-cell weui-cell_access" href="/comments/index?member_id=<?php echo e($member['id']); ?>">
