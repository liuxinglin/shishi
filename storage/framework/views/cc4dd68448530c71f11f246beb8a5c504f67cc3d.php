        ...
        <div class="page__bd">
            <div class="weui-cells weui-cells_form" style="margin-top: 0px">
                ...
                <div class="weui-cell" style="    background: url(/static/home/images/img_adressBG.png) no-repeat;background-position:bottom;background-size:100%;border: none;">
                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $memberAddress; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($value['is_default'] == 1): ?>
                                <div class="weui-cell__hd" style="font-size: 4.5vw; line-height: 9vw">
                                    <p style="font-weight: 600"><?php echo e($value['contacts']); ?>  <?php echo e($value['phone']); ?></p>
                                    <p><?php echo e($value['province'].$value['city'].$value['county'].$value['address']); ?></p>
                                    <input type="hidden" name="address_id" value="<?php echo e($value['id']); ?>">
                                </div>
                            <?php endif; ?>
                ...
                <div class="weui-panel__bd">
                    <div class="weui-media-box weui-media-box_appmsg product-info">
                        <div class="weui-media-box__hd">
                            <img class="weui-media-box__thumb" src="<?php echo e($product['image']); ?>" alt="">
                        </div>
                        <div class="weui-media-box__bd">
                            <h4 class="weui-media-box__title"><?php echo e($product['name']); ?></h4>
                            <p class="weui-media-box__desc"><?php echo e($product['price']); ?></p>
    ...
    <script type="application/javascript">
        ...
        $('.buy').click(function () {
            ...
            $.ajax({
                type: 'POST',
                url: url,
                data: {'member_id': member_id, 'total': total, 'member_address_id': member_address_id, 'quantity': quantity, 'product_id': product_id, '_token': '<?php echo e(csrf_token()); ?>'},
