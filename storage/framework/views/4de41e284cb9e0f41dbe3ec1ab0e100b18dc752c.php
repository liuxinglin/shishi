<?php $__env->startSection('content'); ?>
    <div class="container enrolment" id="container">
        <div class="weui-panel enrol-details">
            ...
            <div class="weui-panel__bd">
                <div class="weui-media-box weui-media-box_appmsg member-info">
                    <div class="weui-media-box__hd">
                        <img class="weui-media-box__thumb" src="<?php echo e($data['member']['headimgurl']); ?>" alt="">
                    </div>
                    <div class="weui-media-box__bd">
                        <h4 class="weui-media-box__title"><?php echo e($data['nickname']); ?></h4>
            ...
            <div class="weui-panel__bd">
                <div class="weui-media-box weui-media-box_appmsg product-info">
                    <div class="weui-media-box__hd">
                        <img class="weui-media-box__thumb" src="<?php echo e($data['tryout']['image']); ?>" alt="">
                    </div>
                    <div class="weui-media-box__bd">
                        <h4 class="weui-media-box__title"><?php echo e($data['tryout']['name']); ?></h4>
                        <p class="weui-media-box__desc">￥<?php echo e($data['tryout']['price']); ?></p>
                    </div>
                </div>
            </div>
        ...
        <div class="weui-panel votes-info">
            <div class="weui-panel__bd">已获得<span><?php echo e($data['votes_num']); ?></span>票，离第一名还差<span><?php echo e($data['vote']['maxVoteNum'] - $data['votes_num']); ?></span>票，加油</div>
            <button class="share">分享给好友，投我一票</button>
            <a href="/tryoutProducts/details?id=<?php echo e($data['tryout_id']); ?>"><button class="enrol-my">查看报名列表</button></a>
            <?php if($data['member']['id'] != session('member.id')): ?>
            <button class="share vote" data-url="/votes/add">帮好友投一票</button>
            <a href="/tryoutProducts/details?id=<?php echo e($data['tryout_id']); ?>"><button class="enrol-my">我也要免费拿</button></a>
                <?php endif; ?>
        </div>
        ...
        <div class="weui-panel weui-panel_access votes-friend">
            ...
            <div class="weui-panel__bd">
                <?php $__currentLoopData = $data['vote']['list']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="weui-media-box weui-media-box_appmsg rowup">
                    <div class="weui-media-box__hd">
                        <img class="weui-media-box__thumb" src="<?php echo e($vote['headimgurl']); ?>" alt="">
                    </div>
                    <div class="weui-media-box__bd">
                        <h4 class="weui-media-box__title"><?php echo e($vote['nickname']); ?></h4>
                        <p><?php echo e($vote['created_at']); ?></p>
                    </div>
...
<?php $__env->startSection('my-js'); ?>
    ...
    <script type="application/javascript">
        $('.vote').click(function () {
            var member_id = '<?php echo e(session('member.id')); ?>';
            var enlt_id = '<?php echo e($data['id']); ?>';
            var url = $(this).attr('data-url');
            $.ajax({
                type: 'POST',
                url: url,
                data: {'member_id': member_id, 'enlt_id': enlt_id, '_token': '<?php echo e(csrf_token()); ?>'},
