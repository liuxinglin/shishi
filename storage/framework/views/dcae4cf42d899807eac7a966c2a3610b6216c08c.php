            ...
            <div class="weui-cells weui-cells_form" style="margin-top: 0px">
                <div class="weui-cell">
                    ...
                    <div class="weui-cell__bd">
                        <input class="weui-input" value="<?php echo e($memberAddress['contacts']); ?>" type="text" name="contacts" placeholder="请输入姓名"/>
                    </div>
                </div>
                <div class="weui-cell">
                    <div class="weui-cell__hd"><label class="weui-label">联系电话</label></div>
                    <div class="weui-cell__bd">
                        <input class="weui-input" value="<?php echo e($memberAddress['phone']); ?>" type="text" name="phone" placeholder="请输入联系电话"/>
                    </div>
                </div>
                <div class="weui-cell">
                    <div class="weui-cell__hd"><label class="weui-label">所在地区</label></div>
                    <div class="weui-cell__bd">
                        <input class="weui-input" value="<?php echo e($memberAddress['area']); ?>" type="text" name="area" placeholder="请输入所在地区"/>
                    </div>
                </div>
                ...
                <div class="weui-cells weui-cells_form"  style="margin-top: 0px">
                    <div class="weui-cell">
                        <div class="weui-cell__bd">
                            <textarea class="weui-textarea" id="address" name="address" placeholder="请输入详细地址，不少于5个字" rows="3"><?php echo e($memberAddress['address']); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->startSection('my-js'); ?>
    ...
    <script type="application/javascript">
        $('.submit').click(function () {
            ...
            var tryout_id = '<?php echo e(isset($_GET['tryout_id']) ? $_GET['tryout_id'] : ''); ?>';
            var url = $(this).attr('data-url');
            $.ajax({
                type: 'POST',
                url: url,
                data: {'member_id': member_id, 'tryout_id': tryout_id, 'phone': phone, 'contacts': contacts, 'address': address, 'area': area, '_token': '<?php echo e(csrf_token()); ?>'},
            ...
            layer.open({
                ...
                yes: function(index){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: url,
                        data: {'member_id': member_id, 'phone': phone, 'varify_code': varify_code, '_token': '<?php echo e(csrf_token()); ?>'},
                        success: function (rst) {
                            console.log(rst);
                            if(rst.status == false) {
                                layer.open({
